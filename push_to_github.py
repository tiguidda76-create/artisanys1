"""
Pushes all source files of Marrakech Craft Conduit (artisanys 1) to GitHub tiguidda76-create/artisanys and tiguidda76-create/marrakech-craft-conduit.
"""
...
REPOS = ["artisanys1", "artisanys", "marrakech-craft-conduit"]
BRANCH = "main"

headers = {
    "Authorization": f"token {TOKEN}",
    "Accept": "application/vnd.github.v3+json",
    "User-Agent": "Artisanys-Deployer"
}
...
def get_all_files():
    file_list = []
    ignore_dirs = {".git", "node_modules", ".agents", ".tmp", "dist", ".vercel"}
    ignore_files = {".env"}
    for root_dir, dirs, files in os.walk(ROOT):
        ...
        for f in files:
            ...
            if rel.startswith(".git/") or rel.startswith("node_modules/") or rel.startswith(".tmp/"):
                continue
...
def push_repo(repo_name):
    ...
    new_commit_payload = {
        "message": "feat: synchronize live Gmail SMTP outreach, Groq AI, and Hassan Tiguidda identity",
        "tree": new_tree,
        "parents": [commit_sha]
    }
